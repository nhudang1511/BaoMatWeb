...
<title>Cửa hàng bán xe đạp trực tuyến</title>
<!-- CSS -->
...
<body>
	...
	<section class="jumbotron text-center">
		<div class="container">
			<h1 class="jumbotron-heading">Cửa hàng bán xe đạp</h1>
			<p class="lead text-muted mb-0">Chào mừng bạn tới cửa hàng bán xe đạp trực tuyến</p>
		</div>
	</section>
</body>