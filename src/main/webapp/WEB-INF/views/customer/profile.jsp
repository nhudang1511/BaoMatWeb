                ...
                <div class="card-body">
                  ...
                  <c:url value="/image?fname=${sessionScope.account.avatar}" var="imgUrl"></c:url>
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-secondary mb-1"> ${sessionScope.account._role}</p>
                ...
                <div class="modal-content">
                    <form action="profile" method="post">
                        ...
                        <div class="modal-body">	
                            ...
                            <%-- <div class="form-group">
                                <label>Avatar</label>
                                <input name="avatar" value="${sessionScope.account.avatar}"  type="file" class="form-control" >
                            </div> --%>
                            <div class="form-group">
                                <label>Cover</label>
